...
def create_app(shared_state: SharedState) -> dash.Dash:
    ...
    app.index_string = (
        ...
        '.rc-slider-mark-text{color:#d1d5db!important;font-size:11px}'
        '.rc-slider-mark-text-active{color:#ecf0f1!important}'
        # Slider tooltip
        '.rc-slider-tooltip{z-index:9999}'
        '.rc-slider-tooltip-inner{background-color:#2d3748!important;'
        'color:#ecf0f1!important;border:1px solid #4a5568!important;'
        'font-size:11px;padding:2px 6px;border-radius:4px;min-width:auto}'
