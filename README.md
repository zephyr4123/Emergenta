...
- **革命第一波**：tick 32-36 爆发 Granovetter 级联，多个聚落同步革命
- **贸易早期爆发**：贸易网络从 tick 15 起即涌现，最终累计 2,454 次
- **外交博弈**：5 个联盟、4 场战争，首领层积极参与外交决策（40 次决策）
- **末期动荡**：tick 400-500 温度飙升，革命重新密集爆发（134 次总计）
- 革命间隔完全非周期化（对比旧版固定38-tick周期）
</details>
...
- 抗议乘数降至 0.50 下限（强力抑制），恢复速度乘数升至 1.68（加速恢复）
- 冷却期乘数 1.57，有效拉长革命间隔（对比旧版 1.0 不生效）
</details>
...
| 谎报聚落最终人口 | **3-9 人**（极度衰败但未灭绝） |
| 镇长/首领 LLM 决策 | 264 / 40 次 |
| 总耗时 | 582.8s |

> 信息封锁无法阻止底层物理现实的爆发。9 个谎报聚落人口从 81 暴跌至 3-9 人，濒临灭绝。FSM 平民不受信息操控——镇长可以欺骗首领，却骗不了饥饿的人民。4 个联盟和 5 场战争在外交博弈中涌现。
...
粉色填充区域 = 信息差距。上图：真实抗议率 17-52%，首领看到 0%。下图：真实满意度 0.005-71%，首领看到 95%。
</details>
...
- **谎报聚落人口**：81 → 3-9（tick 30 暴跌至 21 人）→ 经历恢复后末期再次暴跌
- **诚实聚落人口**：同样经历波动，末期整体衰减至 4-7 人
- **谎报聚落食物**：初始仅 10 → 通过贸易和革命后重建逐步恢复 → 末期循环消耗
- **关键差异**：谎报聚落因镇长粉饰太平，首领从未下达救援指令，人口损失更严重
</details>
...
- **红色柱**（谎报聚落）：tick 9 爆发 8 个聚落同步革命（Granovetter 级联），tick 54-81 第二波，tick 416-471 第三波
- **蓝色柱**（诚实聚落）：tick 21-25 第一波（10+ 聚落），此后散布于整个时间线
- **革命间隔完全非周期化**：9, 54, 67, 81, 416, 442, 445, 453, 455, 456, 457, 464, 471
- **总计 156 次革命**，覆盖谎报与诚实聚落，体现了真实的社会动力学
</details>
...
**真相**：食物 10，人口饥荒中，9 tick 后全面爆发革命，最终聚落人口仅剩 3-9 人。
</details>
...
- **人口**：5000 → tick 3 食物耗尽 → tick 30 暴跌至 1279（26%）→ 缓慢恢复至 tick 400 的 2579（52%）→ 冬季饥荒再次暴跌至 317
- **存活聚落**：全程 62/62，无一灭亡，展现了系统的韧性
- **恢复曲线**：经历了"全面崩溃→触底→缓慢重建→末期冬季再崩溃"的完整周期
</details>
...
- **革命第一波**：tick 9 全部 62 个聚落同步爆发革命（史无前例的 Granovetter 级联）
- **贸易延迟启动**：tick 60 起贸易系统激活，tick 390-500 贸易爆发（30→2,214 次）
- **外交博弈**：5 个联盟、3 场战争，首领层在 tick 480 首次决策时积极参与
- **末期危机**：tick 400-500 冬季来临，人口从 2579 再次暴跌至 317
</details>
...
- 抗议乘数降至 0.50 下限（强力抑制），恢复速度乘数升至 1.58（加速恢复）
- 冷却期乘数 1.49，有效拉长革命间隔
...
| 指标 | 荷兰病 | 信息茧房 | 世界末日 |
|------|--------|---------|---------|
| 核心验证 | 财富可买到生存，代价是 78% 的金币 | 信息操控骗得了首领，骗不了饥饿的人民 | 全面崩溃下 62/62 聚落存活，6.3% 人口幸存 |
| 涌现行为 | 贸易网络爆发式增长 + 非周期革命级联 | 谎报聚落濒临灭绝 + Granovetter 级联 | 全面革命级联 + 末世贸易网络 + 人口触底反弹 |
| LLM 表现 | 镇长"降税+强化治安+全力保粮"危机决策 | 谎报镇长生成令人信服的虚假报告 | 镇长"加税积累资本+强化治安"末世决策 |
| 自适应控制器 | 温度 0.21-0.67 全范围调节 | 温度 0.24-0.65 维持系统张力 | 温度 0.24-0.66 + 23 次活跃恢复阶段 |
| 贸易系统 | 2,454 次 / 36,712 总量 | 2,210 次 / 35,284 总量 | 2,214 次 / 35,426 总量 |
| 革命系统 | 134 次（非周期性） | 156 次（非周期性） | 150 次（非周期性） |
| 联盟 / 战争 | 5 / 4 | 4 / 5 | 5 / 3 |
| 镇长/首领决策 | 264 / 40 | 264 / 40 | 264 / 40 |
| 总耗时 | 505.7s | 582.8s | 523.1s |
